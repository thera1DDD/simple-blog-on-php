...
//    $topTopics = selectTopTopicFromPostsOnindex('posts');
    $posts = selectPostsByTopic($_GET['id'],'posts','users');
    $categoryName = selectOne('topics',['id'=> $_GET['id']]);
?>
...
<div class="container">
    <div class="content row">
        ...
        <div class="main-content col-md-9 col-12">
            <?php if(empty($posts)):?>
            <h2><strong>Записи не найденны</strong></h2>
            <?php else:?>
            <h2><strong><?=$categoryName['name'];?></strong></h2>
